...
def _coerce_time(v):
    """Acepta time o cadena ISO ('20:30', '20:30:00') → time|None.

    preferred_slots es list[dict]: su 'time' vuelve como string tras el
    round-trip de BD y hay que reconstruirlo para no perder las franjas PF.
    """
